var lineAttrs = { 
	...
	"Crossrail 2": 			{ "id":"2", "colour":"#00FF00", "network":"Rail" }, 
	...
	"Thameslink 6tph line": { "id":"0", "colour":"#FF00FF", "network":"Rail" },
};
...
metricInfo["osi"] = {
	...
	"subtitle": "'Hidden' free Out-of-Station Interchanges (OSIs)",
 	"currentDataYear": 2018,
...
metricInfo["tot_yr"] = {
	...
	"subtitle": "Station Entry/Exit Volumes",
 	...
 	"availableDataYears": [2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017],
 	"availableDataYearsByNetwork": {
 		"Tube": [2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017],
...
metricInfo["total"] = metricInfo["tot_yr"];
...
metricInfo["early_in"] = {
	...
	"subtitle": "Station Entry/Exit Volumes",
 	"currentDataYear": 2017,
 	"availableDataYears": [2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2014, 2015, 2016, 2017],
 	"availableDataYearsByNetwork": {
 		"Tube": [2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2014, 2015, 2016, 2017],
 		"DLR": [],
 		"Tramlink": [],
 		"Rail": [],
 		"Emirates Air Line": [],
...
metricInfo["journeys"] = {
	...
	"subtitle": "For selected start station",
 	"currentDataYear": 2017,
 	"availableDataYears": [2012, 2014, 2015, 2016, 2017],
 	"availableDataYearsByNetwork": {
 		"Tube": [2012, 2014, 2015, 2016, 2017],
 		"DLR": [],
 		"Tramlink": [],
 		"Rail": [],
 		"Emirates Air Line": [],
...
metricInfo["wardwork"] = {
 ...
 metricInfo["livesontheline"] = {
	...
	"additional": "Inspired by the original <a href='http://spatial.ly/2012/07/lives-on-the-line/'>Lives on the Line</a><br />by James Cheshire, now with newly updated data.</i> Metric data from <a href='https://www.ons.gov.uk/peoplepopulationandcommunity/healthandsocialcare/healthandlifeexpectancies/articles/healthexpectanciesatbirthformiddlelayersuperoutputareasmsoasengland/2015-09-25'>ONS (2009-2013)</a>, M/F average, full populations for MSOAs touching buffer around tube station centroids.",
 ...
 metricInfo["housepricesdiff"] = {
	...
	"additional": "Using near-live property data for 2-bed houses/flats, from the Zoopla API:<div style='text-align: center; padding: 5px;'><a href='http://zoopla.co.uk/' style='border-width: 0;'><img src='https://www.zoopla.co.uk/static/images/mashery/powered-by-zoopla-150x73.png' style='width: 150px; height: 73px; border-width: 0;' title='Property information powered by Zoopla' alt='Property information powered by Zoopla'></a></div> Excludes listings over 1 year or last updated more than 6 months ago. Also excludes shared ownership/equity. Data is refreshed on a regular basis.",
 	...
 	"keyexample": "The number indicates the average house price change between the last week and three months before",
 	"defaultkey": "10000",
 	"currentDataYear": 2018,
 	"availableDataYears": [2018],
 	"defaultNetworkYear": 2018,
